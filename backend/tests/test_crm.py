...
class _FakeDataSources:
    ...
    async def query(self, *, data_source_id, filter):  # noqa: A002 — mirror Notion's kwarg name
...
class _FakeNotion:
    def __init__(self):
        ...
        self.data_sources = _FakeDataSources(self.store)
...
async def test_crm_push_is_idempotent():
    ...
    page_id_1, created_1 = await crm.sync_change(fake, "ds-id", change, competitor)
    page_id_2, created_2 = await crm.sync_change(fake, "ds-id", change, competitor)
